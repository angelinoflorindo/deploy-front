...
import { aceitarNegociar, rejeitarNegociar } from "@/app/actions/auth";
    ...
    <div>
      ...
      <div className="flex flex-col justify-center items-start p-4 mb-6 shadow-md w-[100%]">
        ...
        <div>
          ...
          <div className="flex flex-row justify-between items-center w-[100%]">
            <span>
              <button onClick={rejeitarProposta} className=" px-2 py-2 bg-red-500  text-white rounded cursor-pointer">Rejeitar</button>
            </span>
            <span>
              <button onClick={aceitarProposta} className="px-2 py-2 bg-violet-500  text-white rounded cursor-pointer">Aceitar</button>
            </span>
          </div>
        </div>
      </div>
