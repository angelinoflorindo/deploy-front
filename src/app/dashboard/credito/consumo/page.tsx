            ...
            <div className="flex flex-col h-screen w-[400px] mx-auto shadow-lg" >
                ...
                <main className="flex-1 overflow-y-auto p-4 bg-white">
                    ...
                    <section className="flex flex-col justify-around align-items-center h-60">
                        <Link href="/dashboard/credito/consumo/solidario" className="flex flex-row w-[100%] justify-start items-center  h-14 shadow-md" >
                            <Image src="/img/proponente.png" className={global.imagens} alt="imagem" width={40} height={40} />
                            Aval solidário
                        </Link>
                        <Link href="/dashboard/credito/consumo/debito" className="flex flex-row w-[100%] justify-start items-center  h-14 shadow-md" >
